...
(define ffi_circle (pointer->procedure '*
  (dynamic-func "libfivestd_circle" stdlib)
  (list '* (list '* '*))))
...
(define ffi_ring (pointer->procedure '*
  (dynamic-func "libfivestd_ring" stdlib)
  (list '* '* (list '* '*))))
...
(define ffi_polygon (pointer->procedure '*
  (dynamic-func "libfivestd_polygon" stdlib)
  (list '* int (list '* '*))))
...
(define ffi_rectangle (pointer->procedure '*
  (dynamic-func "libfivestd_rectangle" stdlib)
  (list (list '* '*) (list '* '*))))
...
(define ffi_rounded-rectangle (pointer->procedure '*
  (dynamic-func "libfivestd_rounded_rectangle" stdlib)
  (list (list '* '*) (list '* '*) '*)))
...
(define ffi_rectangle-exact (pointer->procedure '*
  (dynamic-func "libfivestd_rectangle_exact" stdlib)
  (list (list '* '*) (list '* '*))))
...
(define ffi_rectangle-centered-exact (pointer->procedure '*
  (dynamic-func "libfivestd_rectangle_centered_exact" stdlib)
  (list (list '* '*) (list '* '*))))
...
(define ffi_triangle (pointer->procedure '*
  (dynamic-func "libfivestd_triangle" stdlib)
  (list (list '* '*) (list '* '*) (list '* '*))))
...
(define ffi_box-mitered (pointer->procedure '*
  (dynamic-func "libfivestd_box_mitered" stdlib)
  (list (list '* '* '*) (list '* '* '*))))
...
(define ffi_box-mitered-centered (pointer->procedure '*
  (dynamic-func "libfivestd_box_mitered_centered" stdlib)
  (list (list '* '* '*) (list '* '* '*))))
...
(define ffi_box-exact-centered (pointer->procedure '*
  (dynamic-func "libfivestd_box_exact_centered" stdlib)
  (list (list '* '* '*) (list '* '* '*))))
...
(define ffi_box-exact (pointer->procedure '*
  (dynamic-func "libfivestd_box_exact" stdlib)
  (list (list '* '* '*) (list '* '* '*))))
...
(define ffi_rounded-box (pointer->procedure '*
  (dynamic-func "libfivestd_rounded_box" stdlib)
  (list (list '* '* '*) (list '* '* '*) '*)))
...
(define ffi_sphere (pointer->procedure '*
  (dynamic-func "libfivestd_sphere" stdlib)
  (list '* (list '* '* '*))))
...
(define ffi_half-space (pointer->procedure '*
  (dynamic-func "libfivestd_half_space" stdlib)
  (list (list '* '* '*) (list '* '* '*))))
...
(define ffi_cylinder-z (pointer->procedure '*
  (dynamic-func "libfivestd_cylinder_z" stdlib)
  (list '* '* (list '* '* '*))))
...
(define ffi_cone-ang-z (pointer->procedure '*
  (dynamic-func "libfivestd_cone_ang_z" stdlib)
  (list '* '* (list '* '* '*))))
...
(define ffi_cone-z (pointer->procedure '*
  (dynamic-func "libfivestd_cone_z" stdlib)
  (list '* '* (list '* '* '*))))
...
(define ffi_pyramid-z (pointer->procedure '*
  (dynamic-func "libfivestd_pyramid_z" stdlib)
  (list (list '* '*) (list '* '*) '* '*)))
...
(define ffi_torus-z (pointer->procedure '*
  (dynamic-func "libfivestd_torus_z" stdlib)
  (list '* '* (list '* '* '*))))
...
(define ffi_gyroid (pointer->procedure '*
  (dynamic-func "libfivestd_gyroid" stdlib)
  (list (list '* '* '*) '*)))
...
(define ffi_emptiness (pointer->procedure '*
  (dynamic-func "libfivestd_emptiness" stdlib)
  (list )))
(define* (emptiness )
  "emptiness
