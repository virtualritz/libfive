...
LIBFIVE_STDLIB libfivestd_intersection(
    ...
    libfive_tree a, libfive_tree b);
LIBFIVE_STDLIB libfivestd_inverse(
    // Returns a shape that's the inverse of the input shape
    libfive_tree a);
LIBFIVE_STDLIB libfivestd_difference(
    // Subtracts the second shape from the first
    libfive_tree a, libfive_tree b);
LIBFIVE_STDLIB libfivestd_offset(
...
LIBFIVE_STDLIB libfivestd_loft_between(
...
LIBFIVE_STDLIB libfivestd_cylinder_z(
...
LIBFIVE_STDLIB libfivestd_cone_ang_z(
...
LIBFIVE_STDLIB libfivestd_cone_z(
...
LIBFIVE_STDLIB libfivestd_gyroid(
...
LIBFIVE_STDLIB libfivestd_extrude_z(
...
LIBFIVE_STDLIB libfivestd_rotate_y(
    // Rotate the given shape by an angle in radians
    // The center of rotation is [0 0 0] or specified by the optional argument
    libfive_tree t, tfloat angle, tvec3 center__0);
LIBFIVE_STDLIB libfivestd_rotate_z(
    // Rotate the given shape by an angle in radians
    // The center of rotation is [0 0 0] or specified by the optional argument
    libfive_tree t, tfloat angle, tvec3 center__0);
LIBFIVE_ALIAS(rotate, rotate_z)
LIBFIVE_STDLIB libfivestd_taper_x_y(
...
LIBFIVE_STDLIB libfivestd_taper_xy_z(
    ...
    tfloat scale, tfloat base_scale__1);
LIBFIVE_STDLIB libfivestd_shear_x_y(
...
LIBFIVE_STDLIB libfivestd_repel(
...
LIBFIVE_STDLIB libfivestd_text(
